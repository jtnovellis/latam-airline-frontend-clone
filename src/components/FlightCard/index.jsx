...
function FlightCard(props) {
  ...
  const { id, cityImg, city, returnDate, departDate, tripClass, price, tags } =
    flightDetails;
              ...
              <div className='img-divisor'>
                <picture>
                  <img
                    aria-hidden='true'
                    src={cityImg}
                    alt='first-promotion-of-carousel'
                  ...
                  <div className='position-date'>
                    <div className='date-travel'>
                      <span className='when-is-the-travel'>
                        {returnDate ? (
                          <>
                            Ida <strong>{departDate}</strong> · vuelta{' '}
                ...
                <div className='carousel-item-information'>
                  <div className='information-split'>
                    <div className='carousel-item-city'>
                      <h3 aria-hidden='true' className='city-information'>
                        {city}
                      </h3>
                    </div>
                    <div className='carousel-item-flytype'>
                      <div className='trip-detail'>
                        <div className='one-way-or-round-trip'>
                          {returnDate === '' ? 'Solo ida' : 'Ida y vuelta'}
                        </div>
                      </div>
                      <div className='trip-detail'>
                    ...
                    <div className='carousel-item-price'>
                      <div>
                        <p aria-hidden='true' className='price-description'>
                          Precio final desde
                        </p>
                      ...
                      <div className='red-arrow-item'>
                        <button
                          className='red-round-arrow-button'
                          tabIndex='-1'
                          type='button'
                          data-testid='undefined-icon-button'
                          aria-hidden='true'>
                          <span className='MuiButton-label'>
                            <i className='arrow-icon' aria-hidden='true'>
                              <svg
                                ...
                                <path
                                  fill='currentColor'
                                  d='M8.6 3.4L14.229 9H2v2h12.229L8.6 16.6 10 18l8-8-8-8z'></path>
                              </svg>
                            </i>
                          </span>
                        </button>
